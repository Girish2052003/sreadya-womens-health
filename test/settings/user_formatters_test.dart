...
void main() {
  test(
    'imperial measurement conversions round trip through canonical storage',
    () {
      final celsius = UserFormatters.temperatureForStorage(
        98.6,
        UnitSystem.imperial,
      );
      ...
      expect(
        UserFormatters.weightForDisplay(kg, UnitSystem.imperial),
        closeTo(154.324, 0.01),
      );
