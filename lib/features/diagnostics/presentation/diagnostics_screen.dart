...
class _DiagnosticsScreenState extends ConsumerState<DiagnosticsScreen> {
  ...
  Future<void> _generate() async {
    ...
    final report = await DiagnosticService(
      vault: vault,
        ...
        children: [
          const Card(
            child: Padding(
              ...
              child: Text(
                'Diagnostics are deliberately operational only. Period dates, symptoms, fertility data, medication, pregnancy status, sexual activity and notes are excluded.',
              ),
            ),
          ),
          ...
          FilledButton.icon(
            ...
            label: const Text('Generate diagnostic report'),
          ),
          if (_report != null) ...[
