...
export const publicPages: PublicPage[] = [
  { slug: ['features'], title: 'Features', eyebrow: 'One Sreadya', summary: 'Explore the complete launch capability contract: tracking, predictions, reminders, logging, reproductive observations, life stages, privacy, backup and optional encrypted continuity.' },
  ...
  { slug: ['predictions'], title: 'Predictions', eyebrow: 'Transparent estimates', summary: 'Sreadya uses the same frozen Prediction v1 semantics across clients and communicates confidence rather than certainty.' },
  ...
  { slug: ['insights'], title: 'Insights', eyebrow: 'Your history, made readable', summary: 'Local-first summaries help you notice patterns without sending reproductive-health telemetry to Sreadya.' },
  { slug: ['life-stages'], title: 'Life Stages', eyebrow: 'Built for change', summary: 'Sreadya adapts language and context across life stages while keeping medical boundaries explicit.' },
  ...
  { slug: ['security'], title: 'Security', eyebrow: 'Fail closed', summary: 'Sreadya separates local vault protection, optional continuity and release security with explicit trust boundaries.' },
  { slug: ['sync'], title: 'Sync', eyebrow: 'Optional continuity', summary: 'Optional end-to-end encrypted continuity keeps health content encrypted before it leaves an authorized client while account-free Sreadya remains complete.' },
  ...
  { slug: ['download'], title: 'Download', eyebrow: 'Choose your client', summary: 'Sreadya is designed as one product across Android, iPhone and an installable Web experience.' },
  { slug: ['install', 'iphone'], title: 'Install on iPhone', eyebrow: 'Sreadya on iOS', summary: 'Use the native iOS client when available, or follow the reviewed PWA installation path for the Web client.' },
  { slug: ['install', 'android'], title: 'Install on Android', eyebrow: 'Sreadya on Android', summary: 'Use the signed Android client when available, with the Web install path as a separate browser-native option.' },
  { slug: ['install', 'pwa'], title: 'Install the PWA', eyebrow: 'Browser native', summary: 'Install Sreadya from a supported browser for a focused app-like experience without pretending the browser is a native keystore.' },
  ...
  { slug: ['about'], title: 'About', eyebrow: 'Built with care', summary: 'Sreadya is a privacy-first women’s health product designed around dignity, calm interaction and user control.' },
  ...
  { slug: ['terms'], title: 'Terms', eyebrow: 'Product terms', summary: 'Terms are kept separate from health guidance and never expand Sreadya into unvalidated diagnostic or contraception claims.' },
