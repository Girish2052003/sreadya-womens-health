...
export const publicTopicContent: Record<string, PublicTopic> = {
  "how-it-works": {
    intro: "Sreadya separates your local health experience from optional continuity. Tracking, predictions, insights and reports run on the client; account services never become the health-intelligence engine.",
    sections: [
      { title: "1 · Your device is authoritative", body: "Period history, observations, preferences and local intelligence live in the encrypted Sreadya vault on this device.", href: "/app/home", action: "Open private Sreadya" },
      ...
      { title: "3 · Continuity is optional", body: "When an approved identity/sync service is configured, clients encrypt health content before synchronization. Account-free Sreadya remains complete without that service.", href: "/sync", action: "See the sync boundary" },
    ],
  },
  "cycle-tracking": {
    intro: "Sreadya supports period start/end, corrections, flow, notes, month/timeline/year history, irregular cycles and cycle statistics without forcing a 28-day assumption.",
    sections: [
  ...
  "predictions": {
    intro: "Predictions are estimates from your own valid cycle history. Sreadya shows uncertainty and confidence instead of pretending future biology is certain.",
    sections: [
  ...
  "insights": {
    intro: "Insights summarize your records; they do not invent diagnoses. Sreadya explains the data range and sources behind an observation.",
    sections: [
      ...
      { title: "Prediction accuracy", body: "When actual period outcomes exist, Sreadya can evaluate historical prediction accuracy without turning the result into a medical explanation.", href: "/app/insights", action: "Review accuracy" },
    ],
  },
  "life-stages": {
    intro: "Sreadya adapts context across regular cycles, trying to conceive, pregnancy, postpartum, breastfeeding, perimenopause, menopause transition and hormonal contraception.",
    sections: [
      ...
      { title: "Your mode is private", body: "Life-stage settings are stored in the encrypted local Sreadya vault and do not require an account.", href: "/privacy", action: "Read the privacy model" },
    ],
  },
  "doctor-reports": {
    ...
    sections: [
      ...
      { title: "You decide what leaves", body: "Sreadya does not upload the report to create it. Export is an explicit user action.", href: "/privacy", action: "Review data controls" },
    ],
  },
  "privacy": {
    ...
    sections: [
      ...
      { title: "PIN and platform boundaries", body: "Web supports a local PIN gate and automatic lock. Sreadya does not rename that into native biometric security, and the browser controls screenshots and app-switcher previews.", href: "/app/settings", action: "Open privacy settings" },
  ...
  "security": {
    intro: "Sreadya fails closed around keys, health plaintext and release evidence. Security boundaries are separate for the local vault, optional continuity and software delivery.",
    sections: [
  ...
  "accessibility": {
    intro: "Sreadya provides light/dark presentation, text scaling, reduced motion, high contrast, keyboard/screen-reader semantics, easy-language guidance and locale/RTL formatting infrastructure.",
    sections: [
  ...
  "download": {
    intro: "Choose the Sreadya client that is actually available. This static site does not invent an App Store or Play Store listing that has not been published.",
    sections: [
  ...
  "help": {
    intro: "Start with the task you need. Sreadya keeps recovery, privacy and health actions explicit rather than hiding them behind a generic support form.",
    sections: [
  ...
  "about": {
    intro: "Sreadya is one privacy-first cycle and wellness companion across Android, iOS and Web, with platform-specific adapters but one health-data meaning.",
    sections: [
      ...
      { title: "Health boundaries", body: "Sreadya supports personal tracking and estimates but does not silently turn them into diagnosis, treatment or certified contraception claims.", href: "/terms", action: "Read product boundaries" },
    ],
  },
  "release-notes": {
  ...
  "terms": {
    intro: "Sreadya is a personal tracking and wellness product. Its estimates and observations are not a substitute for professional medical diagnosis, treatment or emergency care.",
    sections: [
  ...
  "security/report": {
    ...
    sections: [
      ...
      { title: "Preserve user privacy", body: "Use synthetic values when a reproduction needs example data. Sreadya diagnostics are designed around allowlisted technical state.", href: "/security", action: "Back to Security" },
    ],
  },
  "security-report": {
