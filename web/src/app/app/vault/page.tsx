        ...
        <header className="workspace-heading">
          <div>
            ...
            <p className="workspace-note">
              Protect local health history and create or restore the interoperable CycleVault recovery format without sending the recovery file or passphrase to Sreadya.
            </p>
          </div>
