...
export function CapabilityCatalogue(){
 ...
 <label className="core-field"><span>{t('catalogue.search')}</span><input type="search" value={query} onChange={e=>setQuery(e.currentTarget.value)} placeholder={t('catalogue.placeholder')}/></label><div aria-live="polite" className="workspace-note">{t('catalogue.showing',{count})}</div>
