    ...
    <div className="core-panel-grid" data-testid="reminder-settings-panel">
      <Card eyebrow="Account-free preferences" title="Reminder settings">
        <fieldset className="reminder-fieldset">
          ...
          <p className="workspace-note">Sreadya enables the private 3-day-before reminder by default. You can change reminder days and time whenever you want.</p>
      ...
      <Card eyebrow="Personal reminder families" title="More than cycle reminders">
        ...
        <p className="workspace-note">These are user-created wellness reminder intents. Sreadya does not prescribe medicine, contraception, tests, or treatment.</p>
      </Card>
